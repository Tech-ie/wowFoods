<?php include('partials-front/menu.php'); ?>
    ...
    <section class="categories">
        <div class="container">
            ...
            //Count rows to check whether the category is availaible or not
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php 
                //Getting food from datavase that are active and featured
                //SQL Query
                ...
                //Check whether food avaialible or not
                if($count>0)
                {
                    //Food Availaible
